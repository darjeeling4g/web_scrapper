...
def add_to_dict(dict_name=None, key=None, value=None):
  if type(dict_name) is not dict:
    dict_type = type(dict_name)
    print(f"You need to send a dictionary. You sent: {dict_type}")
...
def get_from_dict(dict_name=None, key=None):
  if type(dict_name) is not dict:
    dict_type = type(dict_name)
    print(f"You need to send a dictionary. You sent: {dict_type}")
  elif key is None:
    ...
    print(f"{key} wad not found in this dict")
  else:
    print(f"{key}: {my_english_dict[key]}")

def update_word(dict_name=None, key=None, value=None):
  if type(dict_name) is not dict:
    dict_type = type(dict_name)
    print(f"You need to send a dictionary. You sent: {dict_type}")
  elif key is None or value is None:
...
def delete_from_dict(dict_name=None, key=None):
  if type(dict_name) is not dict:
    dict_type = type(dict_name)
    print(f"You need to send a dictionary. You sent: {dict_type}")
  elif key is None:
